...
class SmaCross(Strategy):
    ...
    def next(self):
        ...
        if crossover(self.sma1, self.data.Close) and crossover(
        ...
        elif crossover(self.data.Close, self.sma1) and crossover(
            self.data.Close, self.sma2
        ):
            self.position.close()
            self.sell()
...
class SmaCrossthree(Strategy):
    ...
    def next(self):
        ...
        # short trades, and buy the asset
        if (
            crossover(self.sma1, self.data.Close)
            and crossover(self.sma2, self.data.Close)
            and crossover(self.sma3, self.data.Close)
        ):
            self.position.close()
            self.buy()
        ...
        # long trades, and sell the asset
            ...
            crossover(self.data.Close, self.sma1)
            and crossover(self.data.Close, self.sma2)
            and crossover(self.data.Close, self.sma3)
        ):
            self.position.close()
            self.sell()
...
class EMASMASMA(Strategy):
    ...
    def next(self):
        ...
        # short trades, and buy the asset
        if (
            crossover(self.ema, self.data.Close)
            and crossover(self.sma2, self.data.Close)
            and crossover(self.sma3, self.data.Close)
        ):
            self.position.close()
        ...
        # long trades, and sell the asset
            ...
            crossover(self.data.Close, self.ema)
            and crossover(self.data.Close, self.sma2)
            and crossover(self.data.Close, self.sma3)
        ):
            self.position.close()
...
class EMAEMAEMA(Strategy):
    ...
    def next(self):
        ...
        if (
            crossover(self.ema, self.data.Close)
            and crossover(self.ema1, self.data.Close)
            and crossover(self.ema2, self.data.Close)
        ):
            self.position.close()
            self.buy()
        ...
        # long trades, and sell the asset
            ...
            crossover(self.data.Close, self.ema)
            and crossover(self.data.Close, self.ema1)
...
class EMASMA_dual(Strategy):
    ...
    def next(self):
        ...
        # ema crosses close
        if (
            crossover(self.sma2, self.sma3)
            and crossover(self.sma3, self.ema1)
            and crossover(self.sma1, self.ema1)
            and crossover(self.sma2, self.ema1)
        ):
            self.position.close()
            self.buy()
        ...
        # long trades, and sell the asset
            ...
            crossover(self.data.Close, self.ema1)
            and crossover(self.data.Close, self.sma2)
            and crossover(self.data.Close, self.sma3)
        ):
            self.position.close()
